...
execute if score #Blue ctf_logout matches ..0 as @a[nbt={Inventory:[{id:"minecraft:red_banner", tag: {display: {Name: '"§r§4Red Flag§r"'}}}]}] at @a[nbt={Inventory:[{id:"minecraft:red_banner", tag: {display: {Name: '"§r§4Red Flag§r"'}}}]}] positioned as @e[tag=blue, distance=..500] run tellraw @s [{"text":"You cannot score points while the other team is offline!","color":"yellow"}]
...
execute if score #Blue ctf_logout matches ..0 as @a[nbt={Inventory:[{id:"minecraft:red_banner", tag: {display: {Name: '"§r§4Red Flag§r"'}}}]}] at @a[nbt={Inventory:[{id:"minecraft:red_banner", tag: {display: {Name: '"§r§4Red Flag§r"'}}}]}] positioned as @e[tag=blue, distance=..500] run clear @s red_banner{display:{Name:"\"§r§4Red Flag§r\""}}
...
execute if score #Red ctf_logout matches ..0 as @a[nbt={Inventory:[{id:"minecraft:blue_banner", tag: {display: {Name: '"§r§1Blue Flag§r"'}}}]}] at @a[nbt={Inventory:[{id:"minecraft:blue_banner", tag: {display: {Name: '"§r§1Blue Flag§r"'}}}]}] positioned as @e[tag=red, distance=..500] at @a[nbt={Inventory:[{id:"minecraft:blue_banner", tag: {display: {Name: '"§r§1Blue Flag§r"'}}}]}] positioned as @e[tag=red, distance=..500] run tellraw @s [{"text":"You cannot score points while the other team is offline!","color":"yellow"}]
...
# Clear the flag from the player's inventory
execute if score #Red ctf_logout matches ..0 as @a[nbt={Inventory:[{id:"minecraft:blue_banner", tag: {display: {Name: '"§r§1Blue Flag§r"'}}}]}] at @a[nbt={Inventory:[{id:"minecraft:blue_banner", tag: {display: {Name: '"§r§1Blue Flag§r"'}}}]}] positioned as @e[tag=red, distance=..500] run clear @s blue_banner{display:{Name:"\"§r§1Blue Flag§r\""}}