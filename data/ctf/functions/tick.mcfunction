...
execute as @a[tag=!ctf_flag_held,team=ctf_red,nbt={Inventory:[{id:"minecraft:blue_banner", tag: {display: {Name: '"§r§1Blue Flag§r"'}}}]}] run tellraw @a [{"selector":"@s","color":"dark_red"},{"text":" has stolen the ","color":"yellow"},{"text":"blue flag","color":"blue"},{"text":"!","color":"yellow"}]
...
execute as @a[tag=!ctf_flag_held,team=ctf_blue,nbt={Inventory:[{id:"minecraft:red_banner", tag: {display: {Name: '"§r§4Red Flag§r"'}}}]}] run tellraw @a [{"selector":"@s","color":"blue"},{"text":" has stolen the ","color":"yellow"},{"text":"red flag","color":"dark_red"},{"text":"!","color":"yellow"}]
...
execute if score #Red ctf_cooldown matches ..0 if score #Red ctf_logout matches ..0 if entity @a[team=ctf_blue,limit=1] as @e[tag=red] at @e[tag=red] if block ~1 ~1 ~ minecraft:blue_banner{CustomName: "\"§r§1Blue Flag§r\""} run function ctf:check_point
execute if score #Blue ctf_cooldown matches ..0 if score #Red ctf_logout matches ..0 if entity @a[team=ctf_red,limit=1] as @e[tag=blue] at @e[tag=blue] if block ~1 ~1 ~ minecraft:red_banner{CustomName: "\"§r§4Red Flag§r\""} run function ctf:check_point

# Check if a point is being attempted and cooldown is not over
execute unless score #Red ctf_cooldown matches ..0 if entity @a[team=ctf_blue,limit=1] as @e[tag=red] at @e[tag=red] if block ~1 ~1 ~ minecraft:blue_banner{CustomName: "\"§r§1Blue Flag§r\""} run function ctf:get_flag
execute unless score #Blue ctf_cooldown matches ..0 if entity @a[team=ctf_red,limit=1] as @e[tag=blue] at @e[tag=blue] if block ~1 ~1 ~ minecraft:red_banner{CustomName: "\"§r§4Red Flag§r\""} run function ctf:get_flag

# Remove flags from scored point location and place them back at their respective bases
execute as @e[tag=red] at @e[tag=red] if block ~1 ~1 ~ minecraft:blue_banner{CustomName: "\"§r§1Blue Flag§r\""} at @e[tag=blue] run setblock ~ ~1 ~ minecraft:blue_banner{CustomName: "\"§r§1Blue Flag§r\""}
execute as @e[tag=red] at @e[tag=red] if block ~1 ~1 ~ minecraft:blue_banner{CustomName: "\"§r§1Blue Flag§r\""} run setblock ~1 ~1 ~ minecraft:air
execute as @e[tag=blue] at @e[tag=blue] if block ~1 ~1 ~ minecraft:red_banner{CustomName: "\"§r§4Red Flag§r\""} at @e[tag=red] run setblock ~ ~1 ~ minecraft:red_banner{CustomName: "\"§r§4Red Flag§r\""}
execute as @e[tag=blue] at @e[tag=blue] if block ~1 ~1 ~ minecraft:red_banner{CustomName: "\"§r§4Red Flag§r\""} run setblock ~1 ~1 ~ minecraft:air
