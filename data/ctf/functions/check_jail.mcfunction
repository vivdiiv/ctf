...
execute as @s[team=ctf_blue] run tellraw @a [{"selector":"@s","color":"blue"},{"text":" has been freed from jail!","color":"yellow"}]
...
execute as @s[team=ctf_red] run tellraw @a [{"selector":"@s","color":"dark_red"},{"text":" has been freed from jail!","color":"yellow"}]
# Clears get out of jail card from the team member that freed the other member
